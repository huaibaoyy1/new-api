...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"open_registration_invite_enabled": common.OpenRegistrationInviteEnabled,
		...
		"force_announcement_enabled": common.GetEnvOrDefaultBool("FORCE_ANNOUNCEMENT_ENABLED", true),
		"games_enabled":              common.GetEnvOrDefaultBool("GAMES_ENABLED", true),
